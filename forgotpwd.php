    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tbl_users WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {        
            ...
            try {
                ...
                $mail->Body    = 'Here is the verification link <b><a href="http://localhost/Eyecancer/changepassword.php?reset='.$code.'">http://localhost/Eyecancer/changepassword.php?reset='.$code.'</a></b>';
                ...
                <div class="main-mockup">
                    ...
                    <div class="w3l_form align-self">
                        <div class="left_grid_info">
                            <img src="Authentication_Two Color.png" alt="">
                        </div>
                    </div>
                    <div class="content-wthree">
                        <h2>Forgot Password</h2>
                        <p>Chnage your Password </p>
                        <?php echo $msg; ?>
